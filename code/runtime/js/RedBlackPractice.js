...
RedBlack.prototype.addControls =  function()
{
	...
	this.insertLeftButton = document.getElementById("control-prac-insert-l");
	this.insertLeftButton.onclick=this.insertLeftCallback.bind(this);
	...
	this.leftrotateButton = document.getElementById("control-prac-rotate-l");
	this.leftrotateButton.onclick=this.leftrotateCallback.bind(this);
	this.rightrotateButton = document.getElementById("control-prac-rotate-r");
	this.rightrotateButton.onclick=this.rightrotateCallback.bind(this);
	this.resetButton = document.getElementById("control-prac-reset");
	this.resetButton.onclick=this.reset.bind(this);
	this.showNullLeaves = document.getElementById("control-prac-null");
...
RedBlack.prototype.submitCallback=function(event)
{
	...
	{
		string1="Wrong Answer\n.First Step where you went wrong."
		string1=string1+reasons[wrongsteps[0]]+"\n";
...
{
	if(steps[ptr-1]=="leftrotate")
	{
		document.getElementById("nextcomment").innerHTML="Correct.After inserting we rotate to maintain balance of tree."
		this.insertCallback(this);
	}
	else
	{
		document.getElementById("nextcomment").innerHTML="Incorrect.Hint:After inserting in correct direction we rotate to maintain balance of tree."	
	}
...
RedBlack.prototype.shownext=function(event)
{
	if(ptr+1<insertedvaluelist.length)
		document.getElementById("nextelement").innerHTML=insertedvaluelist[ptr+1]
	else
...
{
	console.log(ptr,steps[ptr-1])
	if(steps[ptr-1]=="right")
	{
		document.getElementById("nextcomment").innerHTML="Correct.Since Element is greater than root, we move toward right"
		this.insertCallback(this);
	}
	else
	{
		document.getElementById("nextcomment").innerHTML="Incorrect.Hint:Element is less than root."
	}
...
RedBlack.prototype.insertLeftCallback = function(event)
{
	...
	if(steps[ptr-1]=="left")
	{
		document.getElementById("nextcomment").innerHTML="Correct.Since Element is less than root, we move toward left"
		this.insertCallback(this);	
	}
	else
	{
		document.getElementById("nextcomment").innerHTML="Incorrect.Hint:Element is greater than root."
	}
}
...
{
	console.log("here",insertedvaluelist.length,ptr)
	if(ptr<insertedvaluelist.length){
		console.log("hey")
		var insertedValue = parseInt(insertedvaluelist[ptr],10);
		console.log(insertedValue)
...
RedBlack.prototype.disableUI = function(event)
{
	...
	this.insertLeftButton.disabled=true;
	this.insertRightButton.disabled=true;
	this.leftrotateButton.disabled=true;
	this.rightrotateButton.disabled=true;
...
RedBlack.prototype.enableUI = function(event)
{
	...
	this.insertButton.disabled = false;
	this.insertLeftButton.disabled=false;
	this.insertRightButton.disabled=false;
	this.leftrotateButton.disabled=false;
	this.rightrotateButton.disabled=false;
